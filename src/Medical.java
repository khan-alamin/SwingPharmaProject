...
class connect {
    ...
    public Connection aconnect() {
        try {
            ...
            con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:orcl", "c##khan", "1234");
        } catch (Exception e) {
...
class WelcomePage extends JFrame implements ActionListener {
    ...
    public void showFrame() {
        ...
        //**************** Frame Properties ***********************
        this.setTitle("Medical Shop Management System");
        this.setVisible(true);
...
//            if (usr.equals("superuser") && psw.equals("1234") || b == 1 || b == 2) {
                if (rb1.isSelected()) {
